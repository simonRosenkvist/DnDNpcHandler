...
GiantOwl.prototype.attack = function() {

	let field = this.parentNode;
	let atkDiv = field.getElementsByClassName('atkDiv')[0];
	let hitDC = new TwentyDice(1)['amount'] + 3;
	let dmg = new SixDice(2)['amount'] + 1;
		
		atkDiv.innerHTML = 'Attack: Talons. Hit DC: ' + hitDC + ' Damage: ' + dmg + ' slashing. <br />';
...
var div = document.createElement('div');
	...
	div.setAttribute('class', 'giantOwl');
...
var attackBtn = document.createElement('button');
	...
	attackBtn.addEventListener('click', GiantOwl.prototype.attack);
