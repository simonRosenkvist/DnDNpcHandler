...
Kobold.prototype.attack = function() {
...
Kobold.prototype.rangeAttack = function() {
	let field = this.parentNode;
	let atkDiv = field.getElementsByClassName('atkDiv')[0];
	let hitDC = new TwentyDice(1)['amount'] + 4;
	let dmg = new FourDice(1)['amount'] + 2;
		
		atkDiv.innerHTML = 'Attack: Sling. Hit DC: ' + hitDC + ' Damage: ' + dmg + ' bludgeoning. Range (30/120)';
...
var senses = ['Darkvision 60ft', 'Passive perception 8'];
...
var notes = ['<strong>Sunlight Sensitivity:</strong> While in sunlight, has disadvantage on attack rolls, as well as on Wisdom (Perception) checks that rely on sight', '<strong>Pack Tactics:</strong> has advantage on an attack roll against a creature if at least one of the kobolds allies is within 5 feet of the creature'];

// == end monster notes ==

// == armaments ==

var armaments = ['Dagger', 'Sling'];
...
var attackBtn = document.createElement('button');
	...
	attackBtn.addEventListener('click', Kobold.prototype.attack);

var rangeAtkBtn = document.createElement('button');
	rangeAtkBtn.innerHTML = 'Atk Range';
	rangeAtkBtn.addEventListener('click', Kobold.prototype.rangeAttack);
