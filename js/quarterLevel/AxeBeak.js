...
AxeBeak.prototype.attack = function() {
	...
	let dmg = new EightDice(1)['amount'] + 2;
		...
		atkDiv.innerHTML = 'Attack: Beak. Hit DC: ' + hitDC + ' Damage: ' + dmg + ' slashing';
...
var div = document.createElement('div');
	...
	div.setAttribute('class', 'axeBeak');
...
var attackBtn = document.createElement('button');
	...
	attackBtn.addEventListener('click', AxeBeak.prototype.attack);
